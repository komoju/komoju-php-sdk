...
/**
 * ChargebackRequestList Class Doc Comment
 *
 * @category Class
 * @package  Komoju
 * @author   OpenAPI Generator team
 ...
 */
class ChargebackRequestList implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ChargebackRequestList';
    ...
    protected static $openAPITypes = [
        'resource' => 'string',
        'data' => '\Komoju\Model\ChargebackRequestListItem[]',
        'start_time' => '\DateTime',
        'end_time' => '\DateTime',
        'total' => 'int',
        'page' => 'int',
     ...
     * Sets resource
     *
     * @param string $resource Resource type name, always \"list\".
     *
     * @return self
     */
     ...
     * Gets data
     *
     * @return \Komoju\Model\ChargebackRequestListItem[]
     */
     ...
     * Sets data
     *
     * @param \Komoju\Model\ChargebackRequestListItem[] $data Array of chargeback request objects for this page.
     *
     * @return self
     */
