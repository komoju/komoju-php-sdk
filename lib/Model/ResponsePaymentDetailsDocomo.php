...
/**
 * ResponsePaymentDetailsDocomo Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  Komoju
 ...
 */
class ResponsePaymentDetailsDocomo implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ResponsePaymentDetailsDocomo';
     ...
     * Sets redirect_url
     *
     * @param string|null $redirect_url URL to redirect the customer to for completing the docomo payment.
     *
     * @return self
     */
    ...
    public function setProviderOrderNumber($provider_order_number)
    {
        ...
        if ((mb_strlen($provider_order_number) > 12)) {
            throw new \InvalidArgumentException('invalid length for $provider_order_number when calling ResponsePaymentDetailsDocomo., must be smaller than or equal to 12.');
        }
