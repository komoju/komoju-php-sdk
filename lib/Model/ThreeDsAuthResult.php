...
class ThreeDsAuthResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['ds_reference_number'] === null) {
            $invalidProperties[] = "'ds_reference_number' can't be null";
        }
        if ($this->container['acs_reference_number'] === null) {
            $invalidProperties[] = "'acs_reference_number' can't be null";
        }
        if ($this->container['three_ds_requestor_trans_id'] === null) {
            $invalidProperties[] = "'three_ds_requestor_trans_id' can't be null";
        }
        if ($this->container['acs_trans_id'] === null) {
            $invalidProperties[] = "'acs_trans_id' can't be null";
        }
        if ($this->container['ds_trans_id'] === null) {
            $invalidProperties[] = "'ds_trans_id' can't be null";
        }
        ...
        if ($this->container['authentication_value'] === null) {
            $invalidProperties[] = "'authentication_value' can't be null";
        }
     ...
     *
     * @param string $ds_reference_number Directory Server reference number for this 3DS transaction.
     *
     * @return self
     */
     ...
     *
     * @param string $acs_reference_number Access Control Server reference number assigned by the card scheme.
     *
     * @return self
     */
     ...
     *
     * @param string $three_ds_requestor_trans_id 3DS requestor transaction ID generated by the merchant's 3DS SDK.
     *
     * @return self
     */
     ...
     * Sets acs_trans_id
     *
     * @param string $acs_trans_id Access Control Server transaction ID assigned by the card issuer.
     *
     * @return self
     */
     ...
     * Sets ds_trans_id
     *
     * @param string $ds_trans_id Directory Server transaction ID for this authentication.
     *
     * @return self
     */
     ...
     * Sets eci
     *
     * @param string $eci Electronic Commerce Indicator indicating the authentication outcome.
     *
     * @return self
     */
     ...
     *
     * @param string $message_version Version of the 3DS protocol used (e.g. \"2.1.0\").
     *
     * @return self
     */
     ...
     *
     * @param string $authentication_type Authentication type used for this 3DS transaction.
     *
     * @return self
     */
     ...
     *
     * @param string $authentication_value Cardholder Authentication Verification Value (CAVV) from the issuer.
     *
     * @return self
     */
     ...
     * Sets trans_status
     *
     * @param string $trans_status Transaction status code (e.g. \"Y\" for authenticated, \"N\" for not authenticated).
     *
     * @return self
     */
     ...
     *
     * @param string $three_ds_server_trans_id 3DS Server transaction ID assigned by the 3DS server.
     *
     * @return self
     */
