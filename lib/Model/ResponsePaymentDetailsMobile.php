...
/**
 * ResponsePaymentDetailsMobile Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  Komoju
 ...
 */
class ResponsePaymentDetailsMobile implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponsePaymentDetailsMobile';
    ...
    */
     ...
     * Sets provider
     *
     * @param string|null $provider Mobile carrier or payment provider for this payment.
     *
     * @return self
     */
     ...
     * Sets redirect_url
     *
     * @param string|null $redirect_url URL to redirect the customer to for completing the mobile payment.
     *
     * @return self
     */
