...
/**
 * ResponsePaymentDetailsBancontact Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  Komoju
 ...
 */
class ResponsePaymentDetailsBancontact implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ResponsePaymentDetailsBancontact';
     ...
     *
     * @param string|null $transaction_key Transaction key returned by Bancontact.
     *
     * @return self
     */
     ...
     * Sets redirect_url
     *
     * @param string|null $redirect_url URL to redirect the customer to for completing the Bancontact payment.
     *
     * @return self
     */
