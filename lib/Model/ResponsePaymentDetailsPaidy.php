...
/**
 * ResponsePaymentDetailsPaidy Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  Komoju
 ...
 */
class ResponsePaymentDetailsPaidy implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ResponsePaymentDetailsPaidy';
     ...
     * Sets redirect_url
     *
     * @param string|null $redirect_url URL to redirect the customer to for completing the Paidy payment.
     *
     * @return self
     */
    ...
    public function setShippingAddressZip($shipping_address_zip)
    {
        ...
        if ((!preg_match("/^[0-9]{3}-[0-9]{4}$/", ObjectSerializer::toString($shipping_address_zip)))) {
            throw new \InvalidArgumentException("invalid value for \$shipping_address_zip when calling ResponsePaymentDetailsPaidy., must conform to the pattern /^[0-9]{3}-[0-9]{4}$/.");
        }
