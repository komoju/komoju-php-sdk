...
/**
 * PaymentDetailsCreditCardKorea Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  Komoju
 ...
 */
class PaymentDetailsCreditCardKorea implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentDetailsCreditCardKorea';
    ...
    */
    ...
    public function setNumber($number)
    {
        ...
        if ((mb_strlen($number) > 19)) {
            throw new \InvalidArgumentException('invalid length for $number when calling PaymentDetailsCreditCardKorea., must be smaller than or equal to 19.');
        }
        if ((mb_strlen($number) < 8)) {
            throw new \InvalidArgumentException('invalid length for $number when calling PaymentDetailsCreditCardKorea., must be bigger than or equal to 8.');
        }
    ...
    public function setMonth($month)
    {
        ...
        if (($month > 12)) {
            throw new \InvalidArgumentException('invalid value for $month when calling PaymentDetailsCreditCardKorea., must be smaller than or equal to 12.');
        }
        if (($month < 1)) {
            throw new \InvalidArgumentException('invalid value for $month when calling PaymentDetailsCreditCardKorea., must be bigger than or equal to 1.');
        }
    ...
    public function setYear($year)
    {
        ...
        if (($year > 2100)) {
            throw new \InvalidArgumentException('invalid value for $year when calling PaymentDetailsCreditCardKorea., must be smaller than or equal to 2100.');
        }
        if (($year < 0)) {
            throw new \InvalidArgumentException('invalid value for $year when calling PaymentDetailsCreditCardKorea., must be bigger than or equal to 0.');
        }
    ...
    public function setFirstTwoDigitsOfPin($first_two_digits_of_pin)
    {
        ...
        if ((mb_strlen($first_two_digits_of_pin) > 2)) {
            throw new \InvalidArgumentException('invalid length for $first_two_digits_of_pin when calling PaymentDetailsCreditCardKorea., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($first_two_digits_of_pin) < 2)) {
            throw new \InvalidArgumentException('invalid length for $first_two_digits_of_pin when calling PaymentDetailsCreditCardKorea., must be bigger than or equal to 2.');
        }
