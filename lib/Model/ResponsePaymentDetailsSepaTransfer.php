...
/**
 * ResponsePaymentDetailsSepaTransfer Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  Komoju
 ...
 */
class ResponsePaymentDetailsSepaTransfer implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ResponsePaymentDetailsSepaTransfer';
     ...
     *
     * @param string|null $transaction_key Transaction key returned by the SEPA transfer provider.
     *
     * @return self
     */
     ...
     * Sets redirect_url
     *
     * @param string|null $redirect_url URL to redirect the customer to for completing the SEPA transfer.
     *
     * @return self
     */
