...
/**
 * PaymentDetailsCreditCardBrazil Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  Komoju
 ...
 */
class PaymentDetailsCreditCardBrazil implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentDetailsCreditCardBrazil';
    ...
    */
    ...
    public function setNumber($number)
    {
        ...
        if ((mb_strlen($number) > 19)) {
            throw new \InvalidArgumentException('invalid length for $number when calling PaymentDetailsCreditCardBrazil., must be smaller than or equal to 19.');
        }
        if ((mb_strlen($number) < 8)) {
            throw new \InvalidArgumentException('invalid length for $number when calling PaymentDetailsCreditCardBrazil., must be bigger than or equal to 8.');
        }
    ...
    public function setMonth($month)
    {
        ...
        if (($month > 12)) {
            throw new \InvalidArgumentException('invalid value for $month when calling PaymentDetailsCreditCardBrazil., must be smaller than or equal to 12.');
        }
        if (($month < 1)) {
            throw new \InvalidArgumentException('invalid value for $month when calling PaymentDetailsCreditCardBrazil., must be bigger than or equal to 1.');
        }
    ...
    public function setYear($year)
    {
        ...
        if (($year > 2100)) {
            throw new \InvalidArgumentException('invalid value for $year when calling PaymentDetailsCreditCardBrazil., must be smaller than or equal to 2100.');
        }
        if (($year < 0)) {
            throw new \InvalidArgumentException('invalid value for $year when calling PaymentDetailsCreditCardBrazil., must be bigger than or equal to 0.');
        }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PaymentDetailsCreditCardBrazil., must be smaller than or equal to 255.');
        }
