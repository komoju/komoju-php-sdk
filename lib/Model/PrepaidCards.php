...
/**
 * PrepaidCards Class Doc Comment
 *
 * @category Class
 * @package  Komoju
 * @author   OpenAPI Generator team
 ...
 */
class PrepaidCards implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PrepaidCards';
    ...
    */
     ...
     *
     * @param string|null $last_four_digits Last four digits of the prepaid card number.
     *
     * @return self
     */
     ...
     * Sets points
     *
     * @param int|null $points Points or remaining balance on this prepaid card.
     *
     * @return self
     */
