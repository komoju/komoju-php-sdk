...
class SubscriptionList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'resource' => 'string',
        'data' => '\Komoju\Model\Subscription[]',
        'start_time' => '\DateTime',
        'end_time' => '\DateTime',
        'total' => 'int',
        'page' => 'int',
     ...
     * Sets resource
     *
     * @param string $resource Resource type name, always \"subscription_list\".
     *
     * @return self
     */
     ...
     * Sets data
     *
     * @param \Komoju\Model\Subscription[] $data Array of subscription objects for this page.
     *
     * @return self
     */
