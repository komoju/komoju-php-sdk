...
/**
 * CreateSessionRequestWithPaymentMode Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  Komoju
 ...
 */
class CreateSessionRequestWithPaymentMode implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'CreateSessionRequestWithPaymentMode';
     ...
     * Sets mode
     *
     * @param string|null $mode In `payment` mode, a payment will be created after customer has completed the session.  `payment` is the default mode and may be omitted.
     *
     * @return self
     */
