...
/**
 * PaymentDetailsHappyMoney Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  Komoju
 ...
 */
class PaymentDetailsHappyMoney implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentDetailsHappyMoney';
    ...
    */
    ...
    public function setHappyMoneyId($happy_money_id)
    {
        ...
        if ((mb_strlen($happy_money_id) > 20)) {
            throw new \InvalidArgumentException('invalid length for $happy_money_id when calling PaymentDetailsHappyMoney., must be smaller than or equal to 20.');
        }
        if ((mb_strlen($happy_money_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $happy_money_id when calling PaymentDetailsHappyMoney., must be bigger than or equal to 1.');
        }
    ...
    public function setHappyMoneyPassword($happy_money_password)
    {
        ...
        if ((mb_strlen($happy_money_password) > 50)) {
            throw new \InvalidArgumentException('invalid length for $happy_money_password when calling PaymentDetailsHappyMoney., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($happy_money_password) < 1)) {
            throw new \InvalidArgumentException('invalid length for $happy_money_password when calling PaymentDetailsHappyMoney., must be bigger than or equal to 1.');
        }
