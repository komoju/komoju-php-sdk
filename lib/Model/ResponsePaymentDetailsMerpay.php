...
/**
 * ResponsePaymentDetailsMerpay Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  Komoju
 ...
 */
class ResponsePaymentDetailsMerpay implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ResponsePaymentDetailsMerpay';
     ...
     *
     * @param string|null $transaction_key Transaction key returned by Merpay.
     *
     * @return self
     */
     ...
     * Sets redirect_url
     *
     * @param string|null $redirect_url URL to redirect the customer to for completing the Merpay payment.
     *
     * @return self
     */
