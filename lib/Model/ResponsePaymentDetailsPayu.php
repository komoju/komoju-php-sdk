...
/**
 * ResponsePaymentDetailsPayu Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  Komoju
 ...
 */
class ResponsePaymentDetailsPayu implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ResponsePaymentDetailsPayu';
     ...
     * Sets redirect_url
     *
     * @param string|null $redirect_url URL to redirect the customer to for completing the PayU payment.
     *
     * @return self
     */
     ...
     * Sets transaction_id
     *
     * @param string|null $transaction_id Transaction identifier returned by PayU.
     *
     * @return self
     */
