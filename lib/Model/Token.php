...
class Token implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'resource' => 'string',
        'created_at' => '\DateTime',
        'payment_details' => '\Komoju\Model\TokenPaymentDetails'
    ];
    ...
    public function setId($id)
    {
        ...
        if ((mb_strlen($id) > 25)) {
            throw new \InvalidArgumentException('invalid length for $id when calling Token., must be smaller than or equal to 25.');
        }
        if ((mb_strlen($id) < 25)) {
            throw new \InvalidArgumentException('invalid length for $id when calling Token., must be bigger than or equal to 25.');
        }
     ...
     * Sets resource
     *
     * @param string $resource Resource type name, always \"token\".
     *
     * @return self
     */
     ...
     * Sets created_at
     *
     * @param \DateTime $created_at Timestamp when the token was created.
     *
     * @return self
     */
     ...
     *
     * @return \Komoju\Model\TokenPaymentDetails
     */
     ...
     *
     * @param \Komoju\Model\TokenPaymentDetails $payment_details payment_details
     *
     * @return self
     */
