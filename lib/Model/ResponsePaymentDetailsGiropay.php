...
/**
 * ResponsePaymentDetailsGiropay Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  Komoju
 ...
 */
class ResponsePaymentDetailsGiropay implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponsePaymentDetailsGiropay';
    ...
    */
     ...
     *
     * @param string|null $transaction_key Transaction key returned by giropay.
     *
     * @return self
     */
     ...
     * Sets redirect_url
     *
     * @param string|null $redirect_url URL to redirect the customer to for completing the giropay payment.
     *
     * @return self
     */
