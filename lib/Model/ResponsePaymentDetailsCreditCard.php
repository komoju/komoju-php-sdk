...
/**
 * ResponsePaymentDetailsCreditCard Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  Komoju
 ...
 */
class ResponsePaymentDetailsCreditCard implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ResponsePaymentDetailsCreditCard';
     ...
     * Sets brand
     *
     * @param string $brand Card brand (e.g. \"visa\", \"mastercard\", \"jcb\").
     *
     * @return self
     */
     ...
     *
     * @param string $last_four_digits Last four digits of the card number.
     *
     * @return self
     */
    ...
    public function setMonth($month)
    {
        ...
        if (($month > 12)) {
            throw new \InvalidArgumentException('invalid value for $month when calling ResponsePaymentDetailsCreditCard., must be smaller than or equal to 12.');
        }
        if (($month < 1)) {
            throw new \InvalidArgumentException('invalid value for $month when calling ResponsePaymentDetailsCreditCard., must be bigger than or equal to 1.');
        }
    ...
    public function setYear($year)
    {
        ...
        if (($year > 2100)) {
            throw new \InvalidArgumentException('invalid value for $year when calling ResponsePaymentDetailsCreditCard., must be smaller than or equal to 2100.');
        }
        if (($year < 0)) {
            throw new \InvalidArgumentException('invalid value for $year when calling ResponsePaymentDetailsCreditCard., must be bigger than or equal to 0.');
        }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ResponsePaymentDetailsCreditCard., must be smaller than or equal to 255.');
        }
    ...
    public function setGivenName($given_name)
    {
        ...
        if ((mb_strlen($given_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $given_name when calling ResponsePaymentDetailsCreditCard., must be smaller than or equal to 255.');
        }
    ...
    public function setFamilyName($family_name)
    {
        ...
        if ((mb_strlen($family_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $family_name when calling ResponsePaymentDetailsCreditCard., must be smaller than or equal to 255.');
        }
