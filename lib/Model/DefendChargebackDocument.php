...
/**
 * DefendChargebackDocument Class Doc Comment
 *
 * @category Class
 * @package  Komoju
 * @author   OpenAPI Generator team
 ...
 */
class DefendChargebackDocument implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'DefendChargebackDocument';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['document_base64'] === null) {
            $invalidProperties[] = "'document_base64' can't be null";
        }
     ...
     *
     * @param string $document_base64 Base64-encoded file contents. Must be 15 MB or less. Supported types: PDF, JPG/JPEG, PNG, GIF.
     *
     * @return self
     */
