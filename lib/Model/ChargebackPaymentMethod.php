...
/**
 * ChargebackPaymentMethod Class Doc Comment
 *
 * @category Class
 ...
 */
class ChargebackPaymentMethod implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ChargebackPaymentMethod';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['last_four_digits'] === null && !$this->isNullableSetToNull('last_four_digits')) {
            $invalidProperties[] = "'last_four_digits' is required";
        }
     ...
     * Sets type
     *
     * @param string $type Payment method type slug (e.g. \"credit_card\").
     *
     * @return self
     */
     ...
     * Sets brand
     *
     * @param string|null $brand Card brand, or null if not applicable.
     *
     * @return self
     */
     ...
     *
     * @param string|null $last_four_digits Last four digits of the card, or null if not applicable.
     *
     * @return self
     */
