...
/**
 * PaymentDetailsKonbini Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  Komoju
 ...
 */
class PaymentDetailsKonbini implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentDetailsKonbini';
    ...
    */
    ...
    public function setPhone($phone)
    {
        ...
        if ((!preg_match("/\\A([() \\-_+]*[0-9]){10}[() \\-_+0-9]*\\Z/", ObjectSerializer::toString($phone)))) {
            throw new \InvalidArgumentException("invalid value for \$phone when calling PaymentDetailsKonbini., must conform to the pattern /\\A([() \\-_+]*[0-9]){10}[() \\-_+0-9]*\\Z/.");
        }
     ...
     * Sets family_name
     *
     * @param string|null $family_name Family name of the customer. It will appear on the Konbini payment receipt.
     *
     * @return self
     */
    public function setFamilyName($family_name)
    {
        ...
        if ((mb_strlen($family_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $family_name when calling PaymentDetailsKonbini., must be smaller than or equal to 255.');
        }
     ...
     * Sets given_name
     *
     * @param string|null $given_name Given name of the customer. It will appear on the Konbini payment receipt.
     *
     * @return self
     */
    public function setGivenName($given_name)
    {
        ...
        if ((mb_strlen($given_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $given_name when calling PaymentDetailsKonbini., must be smaller than or equal to 255.');
        }
