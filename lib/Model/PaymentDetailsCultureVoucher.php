...
/**
 * PaymentDetailsCultureVoucher Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  Komoju
 ...
 */
class PaymentDetailsCultureVoucher implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentDetailsCultureVoucher';
    ...
    */
    ...
    public function setCultureId($culture_id)
    {
        ...
        if ((mb_strlen($culture_id) > 12)) {
            throw new \InvalidArgumentException('invalid length for $culture_id when calling PaymentDetailsCultureVoucher., must be smaller than or equal to 12.');
        }
        if ((mb_strlen($culture_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $culture_id when calling PaymentDetailsCultureVoucher., must be bigger than or equal to 1.');
        }
    ...
    public function setCulturePassword($culture_password)
    {
        ...
        if ((mb_strlen($culture_password) > 20)) {
            throw new \InvalidArgumentException('invalid length for $culture_password when calling PaymentDetailsCultureVoucher., must be smaller than or equal to 20.');
        }
        if ((mb_strlen($culture_password) < 1)) {
            throw new \InvalidArgumentException('invalid length for $culture_password when calling PaymentDetailsCultureVoucher., must be bigger than or equal to 1.');
        }
