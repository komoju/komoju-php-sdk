...
/**
 * PaymentDetailsEnets Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  Komoju
 ...
 */
class PaymentDetailsEnets implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PaymentDetailsEnets';
    ...
    public function setPhone($phone)
    {
        ...
        if ((!preg_match("/\\A([() \\-_+]*[0-9]){10}[() \\-_+0-9]*\\Z/", ObjectSerializer::toString($phone)))) {
            throw new \InvalidArgumentException("invalid value for \$phone when calling PaymentDetailsEnets., must conform to the pattern /\\A([() \\-_+]*[0-9]){10}[() \\-_+0-9]*\\Z/.");
        }
