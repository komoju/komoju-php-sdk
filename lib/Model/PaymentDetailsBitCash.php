...
/**
 * PaymentDetailsBitCash Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  Komoju
 ...
 */
class PaymentDetailsBitCash implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentDetailsBitCash';
    ...
    */
     ...
     * Sets type
     *
     * @param string $type Payment method type.  **Note:** Unlike other prepaid payment methods, this payment method does **NOT** support updating the payment with additional prepaid cards.
     *
     * @return self
     */
    ...
    public function setPrepaidNumber($prepaid_number)
    {
        ...
        if ((mb_strlen($prepaid_number) > 16)) {
            throw new \InvalidArgumentException('invalid length for $prepaid_number when calling PaymentDetailsBitCash., must be smaller than or equal to 16.');
        }
        if ((mb_strlen($prepaid_number) < 16)) {
            throw new \InvalidArgumentException('invalid length for $prepaid_number when calling PaymentDetailsBitCash., must be bigger than or equal to 16.');
        }
