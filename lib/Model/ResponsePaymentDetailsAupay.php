...
/**
 * ResponsePaymentDetailsAupay Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  Komoju
 ...
 */
class ResponsePaymentDetailsAupay implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ResponsePaymentDetailsAupay';
     ...
     * Sets transaction_id
     *
     * @param string|null $transaction_id Transaction identifier returned by au PAY.
     *
     * @return self
     */
     ...
     * Sets redirect_url
     *
     * @param string|null $redirect_url URL to redirect the customer to for completing the au PAY payment.
     *
     * @return self
     */
