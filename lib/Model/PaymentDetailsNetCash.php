...
/**
 * PaymentDetailsNetCash Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  Komoju
 ...
 */
class PaymentDetailsNetCash implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentDetailsNetCash';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['prepaid_number']) > 20)) {
            $invalidProperties[] = "invalid value for 'prepaid_number', the character length must be smaller than or equal to 20.";
        }
    ...
    public function setPrepaidNumber($prepaid_number)
    {
        ...
        if ((mb_strlen($prepaid_number) > 20)) {
            throw new \InvalidArgumentException('invalid length for $prepaid_number when calling PaymentDetailsNetCash., must be smaller than or equal to 20.');
        }
        if ((mb_strlen($prepaid_number) < 16)) {
            throw new \InvalidArgumentException('invalid length for $prepaid_number when calling PaymentDetailsNetCash., must be bigger than or equal to 16.');
        }
