...
/**
 * ResponsePaymentDetailsMobileJapan Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  Komoju
 ...
 */
class ResponsePaymentDetailsMobileJapan implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponsePaymentDetailsMobileJapan';
    ...
    public const PROVIDER_AU = 'au';
    public const PROVIDER_DOCOMO = 'docomo';
    public const PROVIDER_SOFTBANK = 'softbank';
    ...
    public function getProviderAllowableValues()
    {
        return [
            self::PROVIDER_AU,
            self::PROVIDER_DOCOMO,
            self::PROVIDER_SOFTBANK,
        ];
    }
    ...
    */
     ...
     * Sets redirect_url
     *
     * @param string|null $redirect_url URL to redirect the customer to for completing the mobile carrier payment.
     *
     * @return self
     */
