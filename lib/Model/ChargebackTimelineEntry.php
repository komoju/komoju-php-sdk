...
/**
 * ChargebackTimelineEntry Class Doc Comment
 *
 * @category Class
 * @package  Komoju
 * @author   OpenAPI Generator team
 ...
 */
class ChargebackTimelineEntry implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ChargebackTimelineEntry';
     ...
     * Sets type
     *
     * @param string $type Timeline event type (e.g. \"created\", \"defended\", \"response_due\").
     *
     * @return self
     */
     ...
     * Sets occurred_at
     *
     * @param \DateTime $occurred_at When the event occurred.
     *
     * @return self
     */
