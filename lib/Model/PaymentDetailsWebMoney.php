...
/**
 * PaymentDetailsWebMoney Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  Komoju
 ...
 */
class PaymentDetailsWebMoney implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentDetailsWebMoney';
    ...
    */
    ...
    public function setPrepaidNumber($prepaid_number)
    {
        ...
        if ((mb_strlen($prepaid_number) > 16)) {
            throw new \InvalidArgumentException('invalid length for $prepaid_number when calling PaymentDetailsWebMoney., must be smaller than or equal to 16.');
        }
        if ((mb_strlen($prepaid_number) < 16)) {
            throw new \InvalidArgumentException('invalid length for $prepaid_number when calling PaymentDetailsWebMoney., must be bigger than or equal to 16.');
        }
