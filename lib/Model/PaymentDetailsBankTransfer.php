...
/**
 * PaymentDetailsBankTransfer Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  Komoju
 ...
 */
class PaymentDetailsBankTransfer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentDetailsBankTransfer';
    ...
    */
    ...
    public function setPhone($phone)
    {
        ...
        if ((!preg_match("/\\A([() \\-_+]*[0-9]){10}[() \\-_+0-9]*\\Z/", ObjectSerializer::toString($phone)))) {
            throw new \InvalidArgumentException("invalid value for \$phone when calling PaymentDetailsBankTransfer., must conform to the pattern /\\A([() \\-_+]*[0-9]){10}[() \\-_+0-9]*\\Z/.");
        }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PaymentDetailsBankTransfer., must be smaller than or equal to 255.');
        }
    ...
    public function setGivenName($given_name)
    {
        ...
        if ((mb_strlen($given_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $given_name when calling PaymentDetailsBankTransfer., must be smaller than or equal to 255.');
        }
    ...
    public function setFamilyName($family_name)
    {
        ...
        if ((mb_strlen($family_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $family_name when calling PaymentDetailsBankTransfer., must be smaller than or equal to 255.');
        }
    ...
    public function setGivenNameKana($given_name_kana)
    {
        ...
        if ((mb_strlen($given_name_kana) > 255)) {
            throw new \InvalidArgumentException('invalid length for $given_name_kana when calling PaymentDetailsBankTransfer., must be smaller than or equal to 255.');
        }
    ...
    public function setFamilyNameKana($family_name_kana)
    {
        ...
        if ((mb_strlen($family_name_kana) > 255)) {
            throw new \InvalidArgumentException('invalid length for $family_name_kana when calling PaymentDetailsBankTransfer., must be smaller than or equal to 255.');
        }
