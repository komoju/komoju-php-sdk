...
class Session implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets return_url
     *
     * @param string $return_url URL the customer is redirected to after completing or cancelling the session.
     *
     * @return self
     */
     ...
     * Sets cancelled_at
     *
     * @param \DateTime $cancelled_at Timestamp when the session was cancelled, or null if not cancelled.
     *
     * @return self
     */
     ...
     * Sets completed_at
     *
     * @param \DateTime $completed_at Timestamp when the session was completed, or null if not completed.
     *
     * @return self
     */
