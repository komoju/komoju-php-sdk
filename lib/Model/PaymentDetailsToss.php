...
/**
 * PaymentDetailsToss Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  Komoju
 ...
 */
class PaymentDetailsToss implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentDetailsToss';
    ...
    */
    ...
    public function setPhone($phone)
    {
        ...
        if ((!preg_match("/\\A([() \\-_+]*[0-9]){10}[() \\-_+0-9]*\\Z/", ObjectSerializer::toString($phone)))) {
            throw new \InvalidArgumentException("invalid value for \$phone when calling PaymentDetailsToss., must conform to the pattern /\\A([() \\-_+]*[0-9]){10}[() \\-_+0-9]*\\Z/.");
        }
    ...
    public function setBirthday($birthday)
    {
        ...
        if ((mb_strlen($birthday) > 6)) {
            throw new \InvalidArgumentException('invalid length for $birthday when calling PaymentDetailsToss., must be smaller than or equal to 6.');
        }
        if ((mb_strlen($birthday) < 6)) {
            throw new \InvalidArgumentException('invalid length for $birthday when calling PaymentDetailsToss., must be bigger than or equal to 6.');
        }
