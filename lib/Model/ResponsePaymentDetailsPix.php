...
/**
 * ResponsePaymentDetailsPix Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  Komoju
 ...
 */
class ResponsePaymentDetailsPix implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ResponsePaymentDetailsPix';
     ...
     * Sets redirect_url
     *
     * @param string|null $redirect_url URL to redirect the customer to for completing the PIX payment.
     *
     * @return self
     */
     ...
     * Sets qr_code_url
     *
     * @param string|null $qr_code_url URL to the QR code image for the PIX payment.
     *
     * @return self
     */
