...
/**
 * ResponsePaymentDetailsTruemoney Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  Komoju
 ...
 */
class ResponsePaymentDetailsTruemoney implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponsePaymentDetailsTruemoney';
    ...
    */
     ...
     * Sets redirect_url
     *
     * @param string|null $redirect_url URL to redirect the customer to for completing the TrueMoney payment.
     *
     * @return self
     */
