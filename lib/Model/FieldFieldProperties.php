...
class FieldFieldProperties implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets external_links
     *
     * @param string[] $external_links Array of URLs to external resources relevant to this field.
     *
     * @return self
     */
     ...
     * Sets min_length
     *
     * @param int $min_length Minimum character length for the field value.
     *
     * @return self
     */
