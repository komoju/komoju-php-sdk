...
/**
 * ChargebackDefenseDocument Class Doc Comment
 *
 * @category Class
 * @package  Komoju
 * @author   OpenAPI Generator team
 ...
 */
class ChargebackDefenseDocument implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ChargebackDefenseDocument';
     ...
     * Sets content_type
     *
     * @param string $content_type MIME type of the document.
     *
     * @return self
     */
     ...
     * Sets uploaded_at
     *
     * @param \DateTime $uploaded_at When the document was uploaded.
     *
     * @return self
     */
     ...
     * Sets url
     *
     * @param string $url Temporary signed URL to download the document.
     *
     * @return self
     */
