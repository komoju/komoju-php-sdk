...
/**
 * PaymentDetailsDospara Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  Komoju
 ...
 */
class PaymentDetailsDospara implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentDetailsDospara';
    ...
    */
    ...
    public function setUserNo($user_no)
    {
        ...
        if ((mb_strlen($user_no) > 20)) {
            throw new \InvalidArgumentException('invalid length for $user_no when calling PaymentDetailsDospara., must be smaller than or equal to 20.');
        }
    ...
    public function setUserPassword($user_password)
    {
        ...
        if ((mb_strlen($user_password) > 20)) {
            throw new \InvalidArgumentException('invalid length for $user_password when calling PaymentDetailsDospara., must be smaller than or equal to 20.');
        }
