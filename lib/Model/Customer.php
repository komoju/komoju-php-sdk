...
class Customer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'resource' => 'string',
        'email' => 'string',
        'source' => '\Komoju\Model\CustomerSource',
        'metadata' => 'object',
        'created_at' => '\DateTime',
    ...
    public function setId($id)
    {
        ...
        if ((mb_strlen($id) > 25)) {
            throw new \InvalidArgumentException('invalid length for $id when calling Customer., must be smaller than or equal to 25.');
        }
        if ((mb_strlen($id) < 25)) {
            throw new \InvalidArgumentException('invalid length for $id when calling Customer., must be bigger than or equal to 25.');
        }
     ...
     * Sets resource
     *
     * @param string $resource Resource type name, always \"customer\".
     *
     * @return self
     */
     ...
     * Gets source
     *
     * @return \Komoju\Model\CustomerSource|null
     */
     ...
     * Sets source
     *
     * @param \Komoju\Model\CustomerSource|null $source source
     *
     * @return self
     */
     ...
     * Sets metadata
     *
     * @param object $metadata Arbitrary key-value metadata attached to this customer.
     *
     * @return self
     */
