...
/**
 * PaymentDetailsAupay Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  Komoju
 ...
 */
class PaymentDetailsAupay implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentDetailsAupay';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['scanned_code']) && (mb_strlen($this->container['scanned_code']) > 19)) {
            $invalidProperties[] = "invalid value for 'scanned_code', the character length must be smaller than or equal to 19.";
        }

        if (!is_null($this->container['scanned_code']) && (mb_strlen($this->container['scanned_code']) < 19)) {
            $invalidProperties[] = "invalid value for 'scanned_code', the character length must be bigger than or equal to 19.";
        }
     ...
     * Sets scanned_code
     *
     * @param string|null $scanned_code For physical store payment scenario, specify customer's payment code that you've scanned.  When omitted, customer will have to visit a given URL the response to complete the payment.
     *
     * @return self
     */
    public function setScannedCode($scanned_code)
    {
        ...
        if ((mb_strlen($scanned_code) > 19)) {
            throw new \InvalidArgumentException('invalid length for $scanned_code when calling PaymentDetailsAupay., must be smaller than or equal to 19.');
        }
        if ((mb_strlen($scanned_code) < 19)) {
            throw new \InvalidArgumentException('invalid length for $scanned_code when calling PaymentDetailsAupay., must be bigger than or equal to 19.');
        }
