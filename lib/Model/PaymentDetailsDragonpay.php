...
/**
 * PaymentDetailsDragonpay Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  Komoju
 ...
 */
class PaymentDetailsDragonpay implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PaymentDetailsDragonpay';
    ...
    public function setPhone($phone)
    {
        ...
        if ((!preg_match("/\\A([() \\-_+]*[0-9]){10}[() \\-_+0-9]*\\Z/", ObjectSerializer::toString($phone)))) {
            throw new \InvalidArgumentException("invalid value for \$phone when calling PaymentDetailsDragonpay., must conform to the pattern /\\A([() \\-_+]*[0-9]){10}[() \\-_+0-9]*\\Z/.");
        }
