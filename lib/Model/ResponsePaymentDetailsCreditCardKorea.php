...
/**
 * ResponsePaymentDetailsCreditCardKorea Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  Komoju
 ...
 */
class ResponsePaymentDetailsCreditCardKorea implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ResponsePaymentDetailsCreditCardKorea';
    ...
    public function setMonth($month)
    {
        ...
        if (($month > 12)) {
            throw new \InvalidArgumentException('invalid value for $month when calling ResponsePaymentDetailsCreditCardKorea., must be smaller than or equal to 12.');
        }
        if (($month < 1)) {
            throw new \InvalidArgumentException('invalid value for $month when calling ResponsePaymentDetailsCreditCardKorea., must be bigger than or equal to 1.');
        }
    ...
    public function setYear($year)
    {
        ...
        if (($year > 2100)) {
            throw new \InvalidArgumentException('invalid value for $year when calling ResponsePaymentDetailsCreditCardKorea., must be smaller than or equal to 2100.');
        }
        if (($year < 0)) {
            throw new \InvalidArgumentException('invalid value for $year when calling ResponsePaymentDetailsCreditCardKorea., must be bigger than or equal to 0.');
        }
