...
**short_amount** | **int** | Amount the payment is short by if insufficient funds were provided. | [optional]
**prepaid_cards** | [**\Komoju\Model\PrepaidCards[]**](PrepaidCards.md) | List of prepaid cards used in this transaction. | [optional]
